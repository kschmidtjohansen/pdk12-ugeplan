-- Fix the secure function to properly handle role-based access
DROP FUNCTION IF EXISTS public.list_accessible_assignments_with_team();
...
BEGIN
  ...
  SELECT COALESCE(ur.role, 'servicemedarbejder'::user_role) 
