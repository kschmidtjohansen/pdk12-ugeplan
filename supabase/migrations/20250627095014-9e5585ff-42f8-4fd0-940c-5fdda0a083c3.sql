...
-- The issue is likely caused by policies that reference the same table they're protecting
...
-- Allow administrators to view all roles (using the existing is_admin_user function)
...
-- Ensure the functions we're using don't create recursion
