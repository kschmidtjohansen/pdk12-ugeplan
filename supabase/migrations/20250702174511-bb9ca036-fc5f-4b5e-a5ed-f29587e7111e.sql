-- Update assignment SELECT policy to allow servicemedarbejder users to see all published assignments
...
USING (
  ...
  OR
  -- Servicemedarbejder users can see all published assignments
