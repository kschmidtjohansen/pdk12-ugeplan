...
const PlannerPage: React.FC = () => {
  ...
  // Handle moving assignment to a new date (for drag-and-drop)
  const handleMoveAssignment = useCallback(async (id: string, newDate: string) => {
    await moveAssignment(id, newDate);
  }, [moveAssignment]);
