...
const AssignmentCard: React.FC<AssignmentCardProps> = ({
  ...
  return <div className="border rounded-md p-4 bg-white hover:border-polygon-purple transition-colors">
      <div className="flex flex-wrap justify-between items-start gap-2 mb-2">
        <h3 className="font-medium text-lg">{assignment.title}</h3>
        {canEdit && <Button variant="ghost" size="sm" onClick={() => onEdit(assignment)} className="h-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex flex-wrap gap-1">
            {assignment.employees.map((employee, index) => <div key={index}>
