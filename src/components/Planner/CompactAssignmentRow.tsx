  ...
  return (
    <ContextMenu>
      ...
      <td className="py-2.5 px-3 text-right">
        <div 
          className="opacity-0 group-hover:opacity-100 focus-within:opacity-100 [@media(pointer:coarse)]:opacity-100 transition-opacity flex items-center justify-end gap-0.5"
