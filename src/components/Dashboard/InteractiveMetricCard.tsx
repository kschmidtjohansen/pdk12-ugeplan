...
const InteractiveMetricCard: React.FC<InteractiveMetricCardProps> = ({
  ...
  return (
    <Card 
      className={cn(
        'relative overflow-hidden transition-all duration-200 border-l-4 shadow-sm hover:shadow-md cursor-pointer',
        'min-h-[120px]',
        classes.accent,
        classes.hover,
        className
    ...
    >
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-1 px-4 sm:px-6 pt-4">
        ...
        <div className={cn(
          'p-2.5 sm:p-2 rounded-xl border transition-colors duration-200',
          classes.icon
        )}>
