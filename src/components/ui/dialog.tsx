...
const DialogHeader = ({
  ...
  <div
    className={cn("flex flex-col space-y-1.5 text-left relative z-10 pb-4", className)}
    {...props}
  />
);
...
const DialogFooter = ({
  ...
  <div
    className={cn(
      "flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2 space-y-2 space-y-reverse sm:space-y-0 relative z-10 pt-4",
      className
    )}
    {...props}
  />
