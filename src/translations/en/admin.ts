...
export const admin = {
  ...
  subDepartments: {
    ...
    editName: 'Edit name',
    deleteImpactIntro: 'The following will be moved out of the sub-department. Nothing is deleted – it will belong directly to the main department:',
    deleteImpactNone: 'Nothing is linked to this sub-department.',
    deleteImpactLoading: 'Loading overview…',
    deleteImpactAssignments: 'assignments',
    deleteImpactUsers: 'users with access',
    deleteImpactCars: 'vehicles',
    deleteImpactCarLinks: 'vehicle links',
    deleteImpactDuties: 'duties',
    deleteImpactVacations: 'vacation and absence records',
    deleteImpactTrainings: 'trainings',
    deleteImpactWarehouse: 'warehouse items',
    deleting: 'Deleting…',
  ...
  userManagement: {
    ...
    skipDepartmentNote: 'User is created without department affiliation. Suitable for IT Support users.',
  ...
  broadcast: {
    ...
    peopleSearch: 'Search by name or email',
    peopleHint: 'Select no people to send to the whole group above.',
    peopleEmpty: 'No people found.',
    peopleClear: 'Clear selection',
    ...
    testPush: 'Send test to my phone',
    testSent: 'Test notification sent',
    testSentCount: 'Sent to {count} of your devices.',
