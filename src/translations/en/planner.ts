...
const planner = {
  ...
  series: {
    ...
    onlyThisDayDescription: 'Changes only affect the selected day',
    entireSeries: 'This and future days',
    entireSeriesDescription: 'Updates all days in the series from today onward',
    confirm: 'Confirm',
  ...
  conflicts: {
    ...
    bookAvailableOnly: 'Book available days only',
    warningPrefix: 'is unavailable on',
    allDatesConflict: 'All selected dates have conflicts — no days to book',
