...
const employees = {
  ...
  pwTitle: 'Password must contain:',
  pwLength: 'At least 8 characters',
  pwUppercase: 'One uppercase letter',
  pwLowercase: 'One lowercase letter',
  pwNumber: 'One number',
  pwSpecial: 'One special character (recommended)',
  pwRecommendedLength: '12 characters or more (recommended)',
  pwBreachHint: 'Checked automatically against known data breaches',
  pwBreachChecking: 'Checking against known data breaches…',
  pwBreachSafe: 'Not found in known data breaches',
  pwBreachFound: 'This password is known from data breaches — choose another',
  pwBreachUnavailable: 'Could not check against data breaches right now',
  emailChecking: 'Checking the email address…',
  emailAvailable: 'The email address is available',
  emailTakenActive: '{name} already exists with this email and is active. Give the user access to the department under Users instead.',
