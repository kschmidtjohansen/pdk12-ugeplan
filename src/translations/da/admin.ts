...
export const admin = {
  ...
  subDepartments: {
    ...
    editName: 'Rediger navn',
    deleteImpactIntro: 'Følgende bliver flyttet ud af underafdelingen. Intet af det slettes – det ligger derefter direkte under hovedafdelingen:',
    deleteImpactNone: 'Der er intet tilknyttet denne underafdeling.',
    deleteImpactLoading: 'Henter overblik…',
    deleteImpactAssignments: 'opgaver',
    deleteImpactUsers: 'brugere med adgang',
    deleteImpactCars: 'biler',
    deleteImpactCarLinks: 'bil-tilknytninger',
    deleteImpactDuties: 'vagter',
    deleteImpactVacations: 'ferie- og fraværsposter',
    deleteImpactTrainings: 'kurser',
    deleteImpactWarehouse: 'lagerposter',
    deleting: 'Sletter…',
  ...
  broadcast: {
    ...
    peopleEmpty: 'Ingen personer fundet.',
    peopleClear: 'Ryd valg',
    ...
    testPush: 'Send test til min telefon',
    testSent: 'Test-notifikation sendt',
    testSentCount: 'Sendt til {count} af dine enheder.',
    testFailed: 'Kunne ikke sende test-notifikationen',
