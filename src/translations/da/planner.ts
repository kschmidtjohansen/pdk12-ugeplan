...
const planner = {
  ...
  series: {
    ...
    onlyThisDayDescription: 'Ændringer påvirker kun den valgte dag',
    entireSeries: 'Denne og fremadrettede dage',
    entireSeriesDescription: 'Opdaterer alle dage i serien fra og med i dag',
    confirm: 'Bekræft',
  ...
  conflicts: {
    ...
    bookAvailableOnly: 'Book kun ledige dage',
    warningPrefix: 'er utilgængelig d.',
    allDatesConflict: 'Alle valgte datoer har konflikter — ingen dage at booke',
    reasonBooking: 'Booking',
    reasonVacation: 'Ferie',
    reasonPartialVacation: 'Delvis ferie',
    reasonOnLeave: 'Orlov',
    reasonTraining: 'Kursus',
