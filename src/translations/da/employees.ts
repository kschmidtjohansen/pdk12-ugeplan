...
const employees = {
  ...
  pwTitle: 'Adgangskoden skal indeholde:',
  pwLength: 'Mindst 8 tegn',
  pwUppercase: 'Et stort bogstav',
  pwLowercase: 'Et lille bogstav',
  pwNumber: 'Et tal',
  pwSpecial: 'Et specialtegn (anbefales)',
  pwRecommendedLength: '12 tegn eller mere (anbefales)',
  pwBreachHint: 'Kontrolleres automatisk mod kendte datalæk',
  pwBreachChecking: 'Kontrollerer mod kendte datalæk…',
  pwBreachSafe: 'Ikke fundet i kendte datalæk',
  pwBreachFound: 'Adgangskoden er kendt fra datalæk — vælg en anden',
  pwBreachUnavailable: 'Kunne ikke kontrollere mod datalæk lige nu',
  emailChecking: 'Kontrollerer e-mailadressen…',
  emailAvailable: 'E-mailadressen er ledig',
  emailTakenActive: '{name} er allerede oprettet med denne e-mail og er aktiv. Giv i stedet brugeren adgang til afdelingen under Brugere.',
